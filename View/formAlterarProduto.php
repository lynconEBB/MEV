    ...
    if(ValidacaoLogin::autenticar()) {
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5 mt-2">
                <h3 class="display-4 text-light">Alteração de Produtos</h3>
            </div>
                    ...
                    <form action="../Controller/PessoaController.php" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-sm-12">
                                ...
                                <input type="text" name="descricao" id="inputDesc" placeholder="Descrição" value="<?php echo $produto->getDescricao(); ?>" class="form-control"><BR>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-12">
                                <label for="inputPreco">Preço do Produto</label>
                                <input type="text" name="preco" id="inputPreco" placeholder="Preço R$" value="<?php echo $produto->getPreco(); ?>" class="form-control"><BR>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-12">
                                <label for="inputEstoque"> Quantidade em Estoque</label>
                                <input type="text" name="qtdestoque" id="inputEstoque" placeholder="Estoque" value="<?php echo $produto->getQrdestoque(); ?>" class="form-control"><BR>
                            </div>
                        </div>
                        <div class=" form-row">
                            <div class="form-group col-sm-12">
