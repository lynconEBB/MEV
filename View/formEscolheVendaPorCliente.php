...
<?php
    ...
    if (count($pessoas) > 0) {?>
    <div class="container">
        <table class="table bg-info mt-5" align='center'>
            <thead>
            <tr>
                <th scope="col">ID</th>
...
<?php
        foreach ($pessoas as $pessoa) {
            ...
            echo "<td><a href='listarVendaPorCliente.php?id=" . $pessoa->getIdPessoa() . "'><button class='btn btn-success'>Escolher</button></a>";
            echo "</tr>";
        }
        echo "<tr>";
        echo "</tbody>";
