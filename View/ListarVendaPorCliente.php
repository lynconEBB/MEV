...
if(ValidacaoLogin::autenticar()) {?>
    ...
    <head>
        ...
        <title>Listar vendas de Clientes</title>
    </head>
...
<?php
    ...
    foreach ($notas as $nota){
        ...
        echo "<table class='table table-warning mt-2' align='center'>";
        echo "<tr><td colspan='4' align='center' class='display-4'><b>Venda ".$cont."</b></td></tr>";
        echo "<tr>";
        ...
        while ($i < count($produtos)) {
            echo "<td class='text-center bg-warning' >" . $produtos[$i]->getDescricao() . "</td>";
